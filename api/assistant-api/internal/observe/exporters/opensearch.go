...
func (e *OpenSearchExporter) ExportEvent(ctx context.Context, meta observe.SessionMeta, rec observe.EventRecord) error {
...
func (e *OpenSearchExporter) ExportMetric(ctx context.Context, meta observe.SessionMeta, rec observe.MetricRecord) error {
...
func (e *OpenSearchExporter) bulk(ctx context.Context, index string, doc interface{}) error {
	...
	if err := e.connector.Bulk(ctx, sb.String()); err != nil {
		e.logger.Errorf("observe/opensearch: bulk index error: %v", err)
		return err
	}
	return nil
}
